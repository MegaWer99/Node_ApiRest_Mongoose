...
//Bucar especificamente un libro 
router.get('/:id', getBook, async (req, res) => {
    res.json(res.book);
})

// Actualizar datos de algun libro
...
router.patch('/:id', getBook, async (req, res) => {
    ...
    if(!req.body.title && !req.body.author && !req.body.genre && !req.body.publication_date){
        res.status(400).json({
            message: 'Al menos unos de estos campos debe ser enviado: Título, Autor, Genero o Fecha de publicación'
        })
    }
